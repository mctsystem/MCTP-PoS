...
This mechanism has been integrated into Bitcore-Node-MCT which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/mctpay/insight-api-mct#web-socket-api](https://github.com/mctpay/insight-api-mct#web-socket-api)
* API: [https://github.com/mctpay/insight-api-mct#instantsend-transactions](https://github.com/mctpay/insight-api-mct#instantsend-transactions)
...
By default, the MCT Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the MCT Core daemon:
