...
Only requiring some minor changes is mct.cpp.
...
Changes to mct.cpp
----------------------
mct.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
