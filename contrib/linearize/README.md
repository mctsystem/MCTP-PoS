# Linearize
Construct a linear, no-fork, best version of the MCT blockchain. The scripts
...
JSON-RPC server. Running `mctd` or `mct-qt -server` will be sufficient.
...
* `input`: mctd blocks/ directory containing blkNNNNN.dat
