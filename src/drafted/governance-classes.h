 ...
 *
 *   // network
 *   CMCTNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.mct.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMCTNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: MCTNetwork
// //   -- signature requirements : Key1(User)
// class CMCTNetworkVariable : public CGovernanceObject
// {
// private:
