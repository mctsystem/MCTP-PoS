...
in the MCT Core repository under 'Fetch and create inputs' to install sources which require
...
BTCPATH=/some/root/path/mct
SIGPATH=/some/root/path/mct-detached-sigs
